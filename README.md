...
[ifc2xkt](https://github.com/xeokit/xeokit-ifc-to-xkt) is an experimental CLI tool for Node.js that converts geometry from IFC
...
XKT files generated by ````ifc2xkt```` work with [xeokit-sdk](https://github.com/xeokit/xeokit-sdk) versions 1.9 and later.
...
The table below shows benchmarks for ````ifc2xkt```` 0.0.1-alpha using various IFC2x3 and IFC4 files. Click "View" in the last
